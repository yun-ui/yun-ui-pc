<template>
  ...
  <div
    ...
    v-clickoutside="handleClose"
    v-else>
    <i :class="['y-input__icon', 'y-range__icon', triggerClass]"></i>
    <input
      autocomplete="off"
...
import { formatDate, parseDate, isDateObject, getWeekNumber } from 'yun-ui-pc/src/utils/date-util';
    ...
    pickerVisible(val) {
      ...
      if (val) {
        ...
        if (this.validateEvent) {
          this.dispatch('YFormItem', 'el.form.blur');
        }
        this.$emit('blur', this);
        this.blur();
      }
