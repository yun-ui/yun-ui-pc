<template>
  <transition
    ...
    <div
      v-show="visible"
      class="y-time-range-picker y-picker-panel y-popper"
      :class="popperClass">
      <div class="y-time-range-picker__content">
        <div class="y-time-range-picker__cell">
          <div class="y-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
        ...
        <div class="y-time-range-picker__cell">
          <div class="y-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="y-time-range-picker__body y-time-panel__content">
            <time-spinner
      ...
      <div class="y-time-panel__footer">
        <button
          type="button"
          class="y-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="y-time-panel__btn confirm"
          @click="handleConfirm()"
