    ...
    <div
      ...
      <div class="y-picker-panel__body-wrapper">
        ...
        <div class="y-picker-panel__body">
          <div class="y-date-picker__time-header" v-if="showTime">
            ...
            <span class="y-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <y-input
                ref="input"
          ...
          <div
            ...
            <span
              ...
              role="button"
              class="y-date-picker__header-label">{{ yearLabel }}</span>
            <span
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, YInput, YButton
    },
