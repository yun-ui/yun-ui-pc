  ...
  <transition name="y-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      ...
      <div class="y-picker-panel__body-wrapper">
        <slot name="sidebar" class="y-picker-panel__sidebar"></slot>
        ...
        <div class="y-picker-panel__body">
          <div class="y-date-range-picker__time-header" v-if="showTime">
            <span class="y-date-range-picker__editors-wrap">
              ...
              <span class="y-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <y-input
                  size="small"
                  class="y-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="y-icon-arrow-right"></span>
            <span class="y-date-range-picker__editors-wrap is-right">
              ...
              <span class="y-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <y-input
                  size="small"
                  class="y-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="y-picker-panel__content y-date-range-picker__content is-left">
            <div class="y-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="y-picker-panel__icon-btn y-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="y-picker-panel__icon-btn y-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="y-picker-panel__icon-btn y-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="y-picker-panel__icon-btn y-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
...
<script type="text/babel">
  import {
    ...
    extractDateFormat,
    extractTimeFormat
  } from 'yun-ui-pc/src/utils/date-util';
  ...
  export default {
    ...
    methods: {
      ...
      handleRangePick(val, close = true) {
        ...
        // workaround for https://github.com/yun-ui/yun-ui-pc/issues/7539, should remove this block when we don't have to care about Chromium 55 - 57
        setTimeout(() => {
          this.maxDate = maxDate;
          this.minDate = minDate;
        }, 10);
    ...
    components: { TimePicker, DateTable, YInput, YButton }
  };
</script>
