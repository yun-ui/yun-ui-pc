  ...
  >
    <template v-if="type !== 'textarea'">
      ...
      <span
        ...
        <i class="y-input__icon"
          v-if="validateState"
          :class="['y-input__validateIcon', validateIcon]">
        </i>
      </span>
      <!-- 后置元素 -->
    ...
    <span v-if="isWordLimitVisible && type === 'textarea'" class="y-input__count">{{ textLength }}/{{ upperLimit }}</span>
  </div>
</template>
<script>
  ...
  import merge from 'yun-ui-pc/src/utils/merge';
  import {isKorean} from 'yun-ui-pc/src/utils/shared';
  ...
  export default {
      ...
      autoComplete: {
        ...
        validator(val) {
          process.env.NODE_ENV !== 'production' &&
            console.warn('[Yun Warn][Input]\'auto-complete\' property will be deprecated in next major version. please use \'autocomplete\' instead.');
          return true;
        }
      },
      validateEvent: {
    ...
    watch: {
      ...
      // see: https://github.com/yun-ui/yun-ui-pc/issues/14521
      nativeInputValue() {
        this.setNativeInputValue();
      },
      // when change between <input> and <textarea>,
      // update DOM dependent value and styles
      // https://github.com/yun-ui/yun-ui-pc/issues/14857
      type() {
        this.$nextTick(() => {
          this.setNativeInputValue();
          this.resizeTextarea();
    ...
    methods: {
      ...
      handleInput(event) {
        ...
        // see: https://github.com/yun-ui/yun-ui-pc/issues/10516
        if (this.isComposing) return;

        // hack for https://github.com/yun-ui/yun-ui-pc/issues/8548
        ...
        // see: https://github.com/yun-ui/yun-ui-pc/issues/12850
