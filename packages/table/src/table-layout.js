import Vue from 'vue';
import scrollbarWidth from 'yun-ui-pc/src/utils/scrollbar-width';
...
class TableLayout {
  ...
  updateElsHeight() {
    ...
    // fix issue (https://github.com/yun-ui/yun-ui-pc/pull/16956)
    const headerTrElm = headerWrapper ? headerWrapper.querySelector('.y-table__header tr') : null;
