import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'yun-ui-pc/src/utils/dom';
...
export default {
        ...
        <thead class={ [{ 'is-group': isGroup, 'has-gutter': this.hasGutter }] }>
          {
            this._l(columnRows, (columns, rowIndex) =>
              ...
              >
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] }>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="y-table__column-filter-trigger"
                          on-click={ ($event) => this.handleFilterClick($event, column) }>
                          <i class={ ['y-icon-arrow-down', column.filterOpened ? 'y-icon-arrow-up' : ''] }></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
                ...
                {
                  this.hasGutter ? <th class="y-table__cell gutter"></th> : ''
                }
              </tr>
            )
          }
  ...
  mounted() {
    // nextTick 是有必要的 https://github.com/yun-ui/yun-ui-pc/pull/11311
    this.$nextTick(() => {
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.y-table__column-filter-trigger') || cell;
