...
export default {
  ...
  methods: {
    ...
    getColumnYIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn('[Yun Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.');
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnYIndex(children, this.$el);
