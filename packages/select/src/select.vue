<template>
  <div
    class="y-select"
    :class="[selectSize ? 'y-select--' + selectSize : '']"
...
<script type="text/babel">
  ...
  import scrollIntoView from 'yun-ui-pc/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'yun-ui-pc/src/utils/util';
      ...
      autoComplete: {
        ...
        validator(val) {
          process.env.NODE_ENV !== 'production' &&
            console.warn('[Yun Warn][Select]\'auto-complete\' property will be deprecated in next major version. please use \'autocomplete\' instead.');
          return true;
        }
      },
