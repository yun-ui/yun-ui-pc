<template>
  <label
    class="y-checkbox-button"
      :class="[
        size ? 'y-checkbox-button--' + size : '',
    ...
    <span class="y-checkbox-button__inner"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      size() {
        return this._checkboxGroup.checkboxGroupSize || this._elFormItemSize || (this.$YUN || {}).size;
      },
