<template>
  <transition name="viewer-fade">
    <div tabindex="-1" ref="y-image-viewer__wrapper" class="y-image-viewer__wrapper" :style="{ 'z-index': viewerZIndex }">
      <div class="y-image-viewer__mask" @click.self="handleMaskClick"></div>
      <!-- CLOSE -->
      ...
      <template v-if="!isSingle">
        <span
          class="y-image-viewer__btn y-image-viewer__prev"
          :class="{ 'is-disabled': !infinite && isFirst }"
          @click="prev">
          <i class="y-icon-arrow-left"/>
        </span>
        <span
          class="y-image-viewer__btn y-image-viewer__next"
...
<script>
import { on, off } from 'yun-ui-pc/src/utils/dom';
import { rafThrottle, isFirefox } from 'yun-ui-pc/src/utils/util';
...
export default {
  ...
  mounted() {
    ...
    this.$refs['y-image-viewer__wrapper'].focus();
  },
  destroyed() {
