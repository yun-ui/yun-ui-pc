    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="y-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="y-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>

<script>
  import { hasClass } from 'yun-ui-pc/src/utils/dom';
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['y-icon-star-on', 'y-icon-star-on', 'y-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'y-rate__item')) {
            target = target.querySelector('.y-rate__icon');
          }
          if (hasClass(target, 'y-rate__decimal')) {
