    ...
    <div
      ...
      <transition
        ...
        <button
          ...
          class="y-carousel__arrow y-carousel__arrow--left">
      ...
      <transition
        ...
        <button
          ...
          @mouseleave="handleButtonLeave"
          @click.stop="throttledArrowClick(activeIndex + 1)"
          class="y-carousel__arrow y-carousel__arrow--right">
  ...
  methods: {
    ...
    setActiveItem(index) {
      ...
      if (isNaN(index) || index !== Math.floor(index)) {
        console.warn('[Yun Warn][Carousel]index must be an integer.');
        return;
      }
