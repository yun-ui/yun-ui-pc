    ...
    <div
      ...
      <div class="y-message-box" :class="[customClass, center && 'y-message-box--center']">
        ...
        <div class="y-message-box__content">
          ...
          <div class="y-message-box__input" v-show="showInput">
            <y-input
              v-model="inputValue"
              :type="inputType"
              ...
              ref="input"></y-input>
            <div class="y-message-box__errormsg" :style="{ visibility: !!editorErrorMessage ? 'visible' : 'hidden' }">{{ editorErrorMessage }}</div>
          </div>
        </div>
        <div class="y-message-box__btns">
          <y-button
...
<script type="text/babel">
  ...
  import { addClass, removeClass } from 'yun-ui-pc/src/utils/dom';
  import { t } from 'yun-ui-pc/src/locale';
  import Dialog from 'yun-ui-pc/src/utils/aria-dialog';
  ...
  export default {
    ...
    computed: {
      icon() {
        ...
        return iconClass || (type && typeMap[type] ? `y-icon-${ typeMap[type] }` : '');
      },

      confirmButtonClasses() {
        return `y-button--primary ${ this.confirmButtonClass }`;
      },
      cancelButtonClasses() {
    ...
    methods: {
      ...
      getFirstFocus() {
        const btn = this.$el.querySelector('.y-message-box__btns .y-button');
        const title = this.$el.querySelector('.y-message-box__btns .y-message-box__title');
        return btn || title;
      },
      getInputElement() {
