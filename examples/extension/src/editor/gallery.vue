<template>
  <div :style="{ 
    ...
    <y-dialog :visible.sync="copyDialogVisible" :modal-append-to-body="false">
      <y-form :model="copyForm" ref="copyForm" :rules="copyFormRule">
        <y-form-item label="主题名称" prop="name">
          <y-input v-model="copyForm.name"></y-input>
        </y-form-item>
      </y-form>
      <div slot="footer" class="dialog-footer">
        <y-button @click="closeCopyForm">取消</y-button>
        <y-button type="primary" @click="copyToUser">确认</y-button>
      </div>
    </y-dialog>
  </div>
</template>
