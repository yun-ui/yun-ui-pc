...
<div class="buttons">
  <y-button @click="getCheckedNodes">get by node</y-button>
  <y-button @click="getCheckedKeys">get by key</y-button>
  <y-button @click="setCheckedNodes">set by node</y-button>
  <y-button @click="setCheckedKeys">set by key</y-button>
  <y-button @click="resetChecked">reset</y-button>
</div>
