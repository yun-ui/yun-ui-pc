...
```html
<y-input placeholder="Please input password" v-model="input" show-password></y-input>
...
<div class="demo-input-suffix">
  ...
  <y-input
    placeholder="Pick a date"
    v-model="input3">
    <i slot="suffix" class="y-input__icon y-icon-date"></i>
  </y-input>
  <y-input
    placeholder="Type something"
    v-model="input4">
...
```html
<div>
  <y-input placeholder="Please input" v-model="input1">
    <template slot="prepend">Http://</template>
  </y-input>
</div>
<div style="margin-top: 15px;">
  <y-input placeholder="Please input" v-model="input2">
    <template slot="append">.com</template>
  </y-input>
</div>
<div style="margin-top: 15px;">
  <y-input placeholder="Please input" v-model="input3" class="input-with-select">
    <y-select v-model="select" slot="prepend" placeholder="Select">
      <y-option label="Restaurant" value="1"></y-option>
      <y-option label="Order No." value="2"></y-option>
      <y-option label="Tel" value="3"></y-option>
    </y-select>
...
<style>
  ...
  .input-with-select .y-input-group__prepend {
    ...
    methods: {
      ...
      loadAll() {
        return [
          ...
          { "value": "element", "link": "https://github.com/yun-ui/yun-ui-pc" },
...
<y-autocomplete
  ...
  @select="handleSelect">
  <i
    class="y-icon-edit y-input__icon"
    slot="suffix"
...
| ----| ----| ----| ---- | ----- |
|type| type of input | string | text, textarea and other [native input types](https://developer.mozilla.org/en-US/docs/Web/HTML/Yun/input#Form_%3Cinput%3E_types) | text |
