...
```html
<div>
  <y-input placeholder="请输入内容" v-model="input1">
    <template slot="prepend">Http://</template>
  </y-input>
</div>
<div style="margin-top: 15px;">
  <y-input placeholder="请输入内容" v-model="input2">
    <template slot="append">.com</template>
  </y-input>
</div>
<div style="margin-top: 15px;">
  <y-input placeholder="请输入内容" v-model="input3" class="input-with-select">
...
| 参数          | 说明            | 类型            | 可选值                 | 默认值   |
|-------------  |---------------- |---------------- |---------------------- |-------- |
| type         | 类型   | string  | text，textarea 和其他 [原生 input 的 type 值](https://developer.mozilla.org/en-US/docs/Web/HTML/Yun/input#Form_%3Cinput%3E_types) | text |
