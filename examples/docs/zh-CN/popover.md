...
<template>
  <y-popover
    ...
    <y-button slot="reference">hover 激活</y-button>
  </y-popover>
  ...
  <y-popover
    ...
    trigger="click"
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
    <y-button slot="reference">click 激活</y-button>
  </y-popover>
  ...
  <y-button v-popover:popover>focus 激活</y-button>
  ...
  <y-popover
    ...
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
    v-model="visible">
    <y-button slot="reference" @click="visible = !visible">手动激活</y-button>
  </y-popover>
</template>
...
<y-popover
  ...
  <y-table :data="gridData">
    <y-table-column width="150" property="date" label="日期"></y-table-column>
    <y-table-column width="100" property="name" label="姓名"></y-table-column>
    <y-table-column width="300" property="address" label="地址"></y-table-column>
  </y-table>
  <y-button slot="reference">click 激活</y-button>
</y-popover>
