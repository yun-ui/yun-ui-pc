...
<y-upload
  ...
  <div class="y-upload__text">将文件拖到此处，或<em>点击上传</em></div>
...
<y-upload
  ...
  :file-list="fileList"
  :auto-upload="false">
  <y-button slot="trigger" size="small" type="primary">选取文件</y-button>
  <y-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">上传到服务器</y-button>
  <div slot="tip" class="y-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
</y-upload>
<script>
  export default {
...
| accept | 接受上传的[文件类型](https://developer.mozilla.org/en-US/docs/Web/HTML/Yun/input#attr-accept)（thumbnail-mode 模式下此参数无效）| string | — | — |
