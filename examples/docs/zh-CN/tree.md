...
<div class="buttons">
  <y-button @click="getCheckedNodes">通过 node 获取</y-button>
  <y-button @click="getCheckedKeys">通过 key 获取</y-button>
  <y-button @click="setCheckedNodes">通过 node 设置</y-button>
  <y-button @click="setCheckedKeys">通过 key 设置</y-button>
  <y-button @click="resetChecked">清空</y-button>
</div>
