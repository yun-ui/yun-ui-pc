...
```html
<template>
  <y-transfer v-model="value" :data="data"></y-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <y-transfer
      ...
      @change="handleChange"
      :data="data">
      <y-button class="transfer-footer" slot="left-footer" size="small">操作</y-button>
      <y-button class="transfer-footer" slot="right-footer" size="small">操作</y-button>
    </y-transfer>
  </div>
