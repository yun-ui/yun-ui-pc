        ...
        <div class="info-center">
          <div class="title">
            ...
            <span class="right more" v-else>
              <y-dropdown @command="actionClick">
                <i class="y-icon-more"></i>
                <y-dropdown-menu slot="dropdown">
                  <y-dropdown-item command="rename">{{getActionDisplayName('rename-theme')}}</y-dropdown-item>
                  <y-dropdown-item command="copy">{{getActionDisplayName('copy-theme')}}</y-dropdown-item>
                  <y-dropdown-item
                      command="delete"
                      style="color: #F56C6C;"
                    >
...
import dateUtil from 'yun-ui-pc/src/utils/date';
