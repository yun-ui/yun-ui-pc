...
describe('Radio', () => {
  ...
  it('create', done => {
    ...
    let radioElm = vm.$el;
    expect(radioElm.classList.contains('y-radio')).to.be.true;
    radioElm.click();
    setTimeout(_ => {
  ...
  describe('Radio group', () => {
      ...
      vm = createVue({
        template: `
          <y-radio-group v-model="radio">
            <y-radio :label="3" ref="radio1">备选项</y-radio>
            <y-radio :label="6" ref="radio2">备选项</y-radio>
    ...
    it('disabled', done => {
      vm = createVue({
        template: `
          <y-radio-group v-model="radio" disabled>
            <y-radio :label="3" ref="radio1">备选项</y-radio>
            <y-radio :label="6" ref="radio2">备选项</y-radio>
            <y-radio :label="9">备选项</y-radio>
          </y-radio-group>
    ...
    it('change event', done => {
      vm = createVue({
        template: `
          <y-radio-group v-model="radio" @change="onChange">
    ...
    it('disabled when children is radio button', done => {
      vm = createVue({
        template: `
          <y-radio-group v-model="radio" disabled>
            <y-radio-button :label="3" ref="radio1">备选项</y-radio-button>
            <y-radio-button :label="6" ref="radio2">备选项</y-radio-button>
            <y-radio-button :label="9">备选项</y-radio-button>
          </y-radio-group>
        `,
        data() {
          return {
    ...
    it('keyboard event', done => {
      vm = createVue({
        template: `
          <y-radio-group v-model="radio">
            <y-radio-button ref="radio1" :label="3">备选项</y-radio-button>
            <y-radio-button ref="radio2" :label="6">备选项</y-radio-button>
            <y-radio-button ref="radio3" :label="9">备选项</y-radio-button>
          </y-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('custom color', done => {
        vm = createVue({
          template: `
            <y-radio-group v-model="radio" fill="#000" text-color="#ff0">
              <y-radio-button :label="3" ref="radio1">备选项</y-radio-button>
              <y-radio-button :label="6" ref="radio2">备选项</y-radio-button>
              <y-radio-button :label="9">备选项</y-radio-button>
            </y-radio-group>
      ...
      it('change event', done => {
        vm = createVue({
          template: `
            <y-radio-group v-model="radio" @change="onChange">
              <y-radio-button :label="3">备选项</y-radio-button>
              <y-radio-button :label="6" ref="radio2">备选项</y-radio-button>
              <y-radio-button :label="9">备选项</y-radio-button>
            </y-radio-group>
          `,
      ...
      it('size', done => {
        vm = createVue({
          template: `
            <y-radio-group v-model="radio" size="large">
              <y-radio-button :label="3" ref="radio1">备选项</y-radio-button>
              <y-radio-button :label="6" ref="radio2">备选项</y-radio-button>
              <y-radio-button :label="9">备选项</y-radio-button>
            </y-radio-group>
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.y-radio-button--large').length).to.be.equal(3);
          done();
        }, 10);
      });
    });
