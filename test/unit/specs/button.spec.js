...
describe('Button', () => {
  ...
  it('create', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('y-button--primary')).to.be.true;
  });
  it('icon', () => {
    vm = createTest(Button, {
      icon: 'y-icon-search'
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.querySelector('.y-icon-search')).to.be.ok;
  });
  it('nativeType', () => {
    vm = createTest(Button, {
      nativeType: 'submit'
  ...
  it('loading', () => {
    ...
    expect(buttonElm.querySelector('.y-icon-loading')).to.be.ok;
  });
  it('disabled', () => {
    vm = createTest(Button, {
      disabled: true
  ...
  it('size', () => {
    ...
    let buttonElm = vm.$el;
    expect(buttonElm.classList.contains('y-button--medium')).to.be.true;
  });
  it('plain', () => {
    vm = createTest(Button, {
      plain: true
  ...
  it('click inside', done => {
    ...
    vm = createVue({
      template: `
        <y-button @click="handleClick"><span class="inner-slot"></span></y-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
  ...
  it('loading implies disabled', done => {
    ...
    vm = createVue({
      template: `
        <y-button loading @click="handleClick"><span class="inner-slot"></span></y-button>
      `,
      methods: {
        handleClick(evt) {
          result = evt;
