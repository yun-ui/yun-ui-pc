...
describe('Slider', () => {
  ...
  it('hide tooltip', () => {
    vm = createVue({
      template: `
        <div>
          <y-slider v-model="value" :show-tooltip="false">
          </y-slider>
        </div>
      `,
  ...
  it('format tooltip', async() => {
    vm = createVue({
      template: `
        <div>
          <y-slider ref="slider" v-model="value" :format-tooltip="formatTooltip">
          </y-slider>
        </div>
      `,
  ...
  it('drag', done => {
    vm = createVue({
      template: `
        <div>
          <y-slider v-model="value" :vertical="vertical"></y-slider>
        </div>
      `,
  ...
  it('accessibility', done => {
    vm = createVue({
      template: `
        <div>
          <y-slider v-model="value"></y-slider>
        </div>
      `,
    ...
    vm = createVue({
      template: `
        <div style="width: 200px;">
          <y-slider v-model="value" :min="0" :max="1" :step="0.1"></y-slider>
        </div>
      `,
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
        <div>
          <y-slider v-model="value" disabled></y-slider>
        </div>
      `,
  ...
  it('show input', done => {
    vm = createVue({
      template: `
        <div>
          <y-slider v-model="value" show-input></y-slider>
        </div>
      `,
    ...
    setTimeout(() => {
      triggerEvent(vm.$el.querySelector('.y-input-number'), 'keyup');
      const inputNumber = vm.$el.querySelector('.y-input-number').__vue__;
  ...
  it('show stops', () => {
    ...
    const stops = vm.$el.querySelectorAll('.y-slider__stop');
  ...
  it('vertical mode', done => {
    vm = createVue({
      template: `
        <div>
          <y-slider vertical v-model="value" height="200px"></y-slider>
        </div>
      `,
  ...
  describe('range', () => {
    it('basic ranged slider', () => {
      vm = createVue({
        template: `
        <div>
          <y-slider v-model="value" range></y-slider>
        </div>
      `,
    ...
    it('should not exceed min and max', done => {
      vm = createVue({
        template: `
        <div>
          <y-slider v-model="value" range :min="50">
          </y-slider>
        </div>
      `,
    ...
    it('click', done => {
      vm = createVue({
        template: `
        <div style="width: 200px;">
          <y-slider range v-model="value"></y-slider>
        </div>
      `,
    ...
    it('responsive to dynamic min and max', done => {
      vm = createVue({
        template: `
        <div>
          <y-slider v-model="value" range :min="min" :max="max">
          </y-slider>
        </div>
      `,
    ...
    it('marks', async() => {
      ...
      waitImmediate();
      const stops = vm.$el.querySelectorAll('.y-slider__marks-stop.y-slider__stop');
      const marks = vm.$el.querySelectorAll('.y-slider__marks .y-slider__marks-text');
